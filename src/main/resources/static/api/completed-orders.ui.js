export function renderCompletedOrders(orders) {
        ...
        return `
            <div class="order-item border rounded-xl p-4 md:p-6 hover:shadow-md transition-shadow bg-white">
                ...
                <div class="flex items-center justify-between pb-3 border-b border-gray-100">
                    ...
                    <span class="text-green-600 font-semibold text-sm uppercase">Hoàn thành</span>
                </div>
                ...
                <div class="flex flex-col md:flex-row items-center justify-between gap-4 mt-5 pt-4 border-t border-gray-100">
                    ...
                    <div class="flex gap-2 w-full md:w-auto">
                        <button class="btn-return flex-1 md:flex-none px-4 py-2 border border-gray-300 text-gray-600 rounded-lg hover:bg-gray-50 text-sm font-medium transition"
                                data-order-id="${order.orderId}">
                            Trả hàng/Hoàn tiền
                        </button>

                        <button class="btn-review flex-1 md:flex-none px-4 py-2 border border-blue-600 text-blue-600 rounded-lg hover:bg-blue-50 text-sm font-medium transition">
                            Đánh giá
                        </button>
